...
/********************************************************************************************************************
 * @author 	:Pramila0526
 * Purpose	:AddressBook Implementation
 *
****************************************************************************************/
public class AddressBookReadWrite 
{
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException
	{
		...
		persons.addAll(model.getPerson());
		// adding person
		...
		Long numberSearch = (long) Utility2.longInput();
		int indexOfPerson = 0;
		boolean isFoundPerson = false;
		for (int i = 0; i < persons.size(); i++) {
			if (numberSearch.equals(persons.get(i).getMobile()) ){
				isFoundPerson = true;
				indexOfPerson = i;
				System.out.println("Person found with"+numberSearch);
				break;
			}
		}
