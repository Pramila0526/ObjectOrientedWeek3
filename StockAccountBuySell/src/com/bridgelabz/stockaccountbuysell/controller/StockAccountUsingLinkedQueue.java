...
import com.bridgelabz.stockaccountbuysell.service.LinkedQueue;
import com.bridgelabz.stockaccountbuysell.util.StockUtility;

public class StockAccountUsingLinkedQueue
{
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		if (isCustomerFound) {
			while (!isExit) {
				System.out.println("\n====Welcome!!" + customerList.get(indexOfCustomer).getCustomerName() + "====");
				System.out.println();
				...
				System.out.println("------------------");
				System.out.println("4) Transaction Data Using Linked Queue");
				System.out.println("------------------");
				...
				case 2:
					...
					if (isCompanyFound) {
						...
						//method for  checking whether user has enough amount to buy or not
						if (numberOfCompanySharesToBuy < companyList.get(indexOfCompany).getCompanyShares()) {
							//method for checking user has enough balance or not
							if (customerBalance > (numberOfCompanySharesToBuy
								...
								// method for total value of company
								companyList.get(indexOfCompany)
										.setCompanyTotalValue(companyList.get(indexOfCompany).getCompanySharePrice()
												* companyList.get(indexOfCompany).getCompanyShares());
				...
				case 4:
					...
					LinkedQueue<Transactions> list=new LinkedQueue<Transactions>();
					//transactionModel =mapper.readValue(path,TransactionsModel.class);
					System.out.println("Transaction In Linked Queue");
					list.addAllLinkedQueue(transactionModel.getTransactions());
					list.display();
