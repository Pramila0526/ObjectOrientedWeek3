...
import com.bridgelabz.stockaccountbuysell.service.Stack;
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		if (isCustomerFound) {
			while (!isExit) {
				...
				System.out.println("------------------");
				System.out.println("4) Transaction data using Stack");
				System.out.println("------------------");
				...
				case 4:
					...
					System.out.println("Transaction In Stack");
					stack.pushAllInStack(transactionModel.getTransactions());
					stack.display();
