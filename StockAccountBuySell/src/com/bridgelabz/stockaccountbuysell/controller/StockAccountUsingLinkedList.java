...
import com.bridgelabz.stockaccountbuysell.service.LinkedList;
import com.bridgelabz.stockaccountbuysell.util.StockUtility;
/****************************************************************************************************
 * @author Pramila0526
 * Purpose	:Stock Account Using LinkedList
 *
 ************************************************************************************/
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		if (isCustomerFound) {
			while (!isExit) {
				...
				System.out.println("------------------");
				System.out.println("4) Transaction data using Linked List");
				System.out.println("------------------");
				...
				case 3:
					...
					break;
				case 4:
					LinkedList<Transactions> list=new LinkedList<Transactions>();
					//transactionModel =mapper.readValue(path,TransactionsModel.class);
					System.out.println("Transaction In LinkedList");
					list.addAll1(transactionModel.getTransactions());
					list.display();
